"""Third-party license audit (ST-21-02, Spec v1.0 Public Release §4).
...
report; it audits installed Python/JS packages only, as scoped by ST-21-02's own acceptance
criteria for `pip-licenses`/`license-checker`-equivalent tooling).
"""
...
def render_report(python_findings: list[Finding], npm_findings: list[Finding]) -> str:
    ...
    lines.append("")
    lines.append(
        "Generated by `scripts/license_audit.py` (ST-21-02, Spec v1.0 Public Release §4). "
